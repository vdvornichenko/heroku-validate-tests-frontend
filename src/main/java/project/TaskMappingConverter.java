...
public class TaskMappingConverter implements JsonSerializer<TaskMapping>, JsonDeserializer<TaskMapping> {
//public class TaskMappingConverter implements  JsonDeserializer<Object> {

    public JsonElement serialize(TaskMapping src, Type type, JsonSerializationContext context) {

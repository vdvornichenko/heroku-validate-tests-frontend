...
export var HTTP_CHECK_SESSION_URL = (window.location.href.includes('localhost')) ? 'http://localhost:8080/sessionChecking' : 'https://task-validation-lc.herokuapp.com/sessionChecking';
...
export const AUTH_TOKEN = 'task-validation-vue-js-spring-vrp-company-token';
export const USER_SESSION = 'task-validation-vue-js-spring-vrp-company-username';
